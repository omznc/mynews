			...
			<div className="flex items-center md:w-fit w-full justify-between gap-4">
				...
				<Drawer open={open} onOpenChange={setOpen}>
					...
					<DrawerContent className="min-w-full">
						{user ? (
							<DrawerHeader>
								<DrawerTitle>Welcome back, {user?.name}!</DrawerTitle>
								<DrawerDescription>Ready to explore?</DrawerDescription>
								<button
									type="button"
									onClick={async () => {
									...
									className="transition-all group flex flex-row md:flex-col items-center md:justify-center rounded-md p-2 md:p-0 md:h-[75px] w-full md:w-[75px] gap-2 md:gap-1 bg-white"
								>
							...
							<>
								<DrawerHeader>
									<DrawerTitle>Join us!</DrawerTitle>
									<DrawerDescription>
						...
						<DrawerHeader>
							...
							<DrawerDescription>Time to explore!</DrawerDescription>
						</DrawerHeader>
